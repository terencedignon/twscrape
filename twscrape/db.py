...
async def migrate(db: aiosqlite.Connection):
    ...
    async def v5():
        await db.execute("ALTER TABLE accounts ADD COLUMN error_history TEXT DEFAULT '[]' NOT NULL")
        await db.execute("ALTER TABLE accounts ADD COLUMN reactivation_priority INTEGER DEFAULT 0 NOT NULL")
